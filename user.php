...
$stat_ads=true;
$Per-mana = $putih.'[*] '.$ijo.'subcribe youtube Per-mana '.$putih.'[-] code: '.$ijo.'J62347';
$ads= $putih.'[*] '.$ijo.'subcribe youtube Per-mana '.$putih.'[-] code: '.$ijo.'J62347'.$t.$putih."[÷]    official channel    [÷]".$t.$ijo."[-] adi bordir ".$putih."| atau |".$ijo." sungging [-]";
...
'Mertua Muda','Abi Utomo Aji','Abi Rizki','Astar','TappeiMix','Iwan Etet','Rois Hasan','irfan hartanto','Ilham','Erik Rizal','Amir Mboyz','Iwanz Chriztchrouw Seven','Sheena callysta almira','Per-mana',
 ];
$toto = ['tes',];
$ydnews = ['tes','per-mana',];
