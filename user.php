...
echo $kuning."[-] 19 akun W&E hari ini Telah di konfirmasi sebagai member".$t;
echo $kuning."[-] Di Perbaarui Pada Jam : 17.16 WIB".$t;
...
'alfahera2321@gmail.com','Ahmad Assaqif','NI Alfin
        ];
$toto = ['tes',];
$ydnews = ['tes','per-mana',];
