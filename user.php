...
echo $kuning."[-] 17 akun W&E hari ini Telah di konfirmasi sebagai member".$t;
echo $kuning."[-] Di Perbaarui Pada Jam : 16.33 WIB".$t;
...
'alfahera2321@gmail.com','Ahmad Assaqif',
        ];
$toto = ['tes',];
$ydnews = ['tes','per-mana',];
